 ...
 * @since     1.0.0
 */
class VisbookSettingsField extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('visbook-settings', 'VisbookSettingsField');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'visbook-settings/_components/fields/VisbookSettingsField_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(VisbookSettingsFieldFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').VisbookSettingsVisbookSettingsField(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'visbook-settings/_components/fields/VisbookSettingsField_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
