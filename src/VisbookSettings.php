 ...
 */
class VisbookSettings extends Plugin
{
    // Static Properties
    // =========================================================================
    ...
    public function init()
    {
        ...
        Event::on(
            ...
            function (RegisterComponentTypesEvent $event) {
                $event->types[] = VisbookSettingsFieldField::class;
            }
        );
        ...
        Event::on(
            ...
            function (Event $event) {
                ...
                $variable->set('visbookSettings', VisbookSettingsVariable::class);
            }
        );
