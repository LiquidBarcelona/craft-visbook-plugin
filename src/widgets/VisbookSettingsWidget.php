...
namespace liquidstudiovisbook\visbooksettings\widgets;

use liquidstudiovisbook\visbooksettings\VisbookSettings;
use liquidstudiovisbook\visbooksettings\assetbundles\visbooksettingswidgetwidget\VisbookSettingsWidgetWidgetAsset;

use Craft;
use craft\base\Widget;

/**
 * Visbook Settings Widget
 *
...
class VisbookSettingsWidget extends Widget
{
    ...
    {
        return Craft::getAlias("@liquidstudiovisbook/visbooksettings/assetbundles/visbooksettingswidgetwidget/dist/img/VisbookSettingsWidget-icon.svg");
    }
