...
/**
 * VisbookSettingsWidgetWidgetAsset AssetBundle
 *
 ...
 * @since     1.0.0
 */
class VisbookSettingsWidgetWidgetAsset extends AssetBundle
{
    // Public Methods
    // =========================================================================
    ...
    public function init()
    {
        ...
        $this->js = [
            'js/VisbookSettingsWidget.js',
        ];

        $this->css = [
            'css/VisbookSettingsWidget.css',
        ];
